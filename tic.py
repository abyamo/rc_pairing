# version 1 that prints empty grid and has commented but unimplemented game logic
...
def main():
    ...
    while turn_counter < 9:
        ...
        # updates gameGrid [X or O depending on curr_player; X if curr_player = 1 and O if player2], > gameGrid[input-1]
