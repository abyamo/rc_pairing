4 different files even though version control is a thing so that the scratchpad > code process is laid bare in the era of codegen machines. But mostly because I wanted three files names tic, tac and toe. 
